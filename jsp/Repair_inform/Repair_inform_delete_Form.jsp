...
@media (max-width:500px) {
  ...
  <div>
    <div class="panel shadow1">
         <form class="login-form" method="post" action="Repair_inform_delete_Pro.jsp">
             <h1 class="animated fadeInUp animate1" id="title-login">정비 정보 삭제</h1>
             <h5>삭제하려는 정비 번호를 입력하세요</h5>
             <br>
             ...
             <input type="submit" class="login_form button animated fadeInUp animate4" action="Repair_inform_delete_Pro.jsp" value="입력완료">
