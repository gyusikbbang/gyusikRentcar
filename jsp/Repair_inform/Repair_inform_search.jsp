...
<div class="animated bounceInDown">
  <div class="container">
	...
	<table>
		<caption><a style="float:left; font-size: 1.5em;" >정비정보 검색</a></caption>
		<caption><br></caption>
		<thead>
			<tr>
				<th>정비번호</th>
	...
	<tbody>
		<%
			...
			conn = DriverManager.getConnection(url, user, password);
				...
				if(!"".equals(word)){
					word = "%" + word + "%";
					sql += "where 1 = 1 and repair_number like ? order by repair_number";					
				}
				...
				while(rs.next()){
							String repair_number = rs.getString("repair_number");
							String car_id = rs.getString("car_id");
							String repair_shop_id =rs.getString("repair_shop_id");
							String repair_contents =rs.getString("repair_contents");
							String repair_date =rs.getString("repair_date");
							String repair_price =rs.getString("repair_price");
							String price_deadline =rs.getString("price_deadline");
							String cus_driver_license_id =rs.getString("cus_driver_license_id");
							String add_repair_contents =rs.getString("add_repair_contents");
							String repair_end_date =rs.getString("repair_end_date");
		...
		<tr>
			<td><%=repair_number%></td>
							...
							<td><%=repair_shop_id%></td>
							<td><%=cus_driver_license_id%></td>
							                     
							<td><%=repair_contents%></td>
							<td><%=repair_date%></td>
							<td><%=repair_price%></td>
							<td><%=price_deadline%></td>
							<td><%=add_repair_contents%></td>
							<td><%=repair_end_date%></td>
...
<tfoot>
	<td colspan="10" class="tablefoot"></td>
	   ...
	   <br>
	   <br>
      <span><a href="Repair_inform_Select.jsp">돌아가기</a></span>
    </div>
</div>
