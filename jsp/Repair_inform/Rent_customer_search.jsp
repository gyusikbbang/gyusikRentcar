...
<div class="animated bounceInDown">
  <div class="container">
	...
	<table>
		<caption><a style="float:left; font-size: 1.5em;" >고객 검색</a></caption>
		<caption><br></caption>
		<thead>
			<tr>
				<th>운전면허증ID</th>
	...
	<tbody>
		<%
			...
			conn = DriverManager.getConnection(url, user, password);
				...
				if(!"".equals(word)){
					word = "%" + word + "%";
					sql += "where 1 = 1 and cus_name like ? order by cus_name";					
				}
				...
				while(rs.next()){
							...
							String use_num =rs.getString("use_num");
							String used_car_type =rs.getString("used_car_type");
							String used_date =rs.getString("used_date");
...
<tfoot>
	<td colspan="10" class="tablefoot"></td>
	   ...
	   <br>
	   <br>
      <span><a href="Rent_customer_Select.jsp">돌아가기</a></span>
    </div>
</div>
