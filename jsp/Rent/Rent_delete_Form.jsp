    ...
    <body>
        <div>
           <div class="panel shadow1">
                <form class="login-form" method="post" action="Rent_delete_Pro.jsp">
                    <h1 class="animated fadeInUp animate1" id="title-login">대여 정보 삭제</h1>
                
                    <h5>삭제하려는 정보의 대여ID를 입력하세요</h5>
                    <br>
                    <br>
                    <br>
                    ...
                    <input type="submit" class="login_form button animated fadeInUp animate4" action="Rent_delete_Pro.jsp" value="입력완료">
