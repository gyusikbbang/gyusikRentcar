...
@media (max-width:500px) {
  ...
  <div>
    <div class="panel shadow1">
         <form class="login-form" method="post" action="Rent_Pro.jsp">
             <h1 class="animated fadeInUp animate1" id="title-login">대여 정보 추가</h1>
             <h5>추가하려는 대여 정보를 입력하세요</h5>
             <br>
             ...
             <input type="submit" class="login_form button animated fadeInUp animate4" action="Rent_Pro.jsp" value="입력완료">
