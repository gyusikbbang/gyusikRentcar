...
@media (max-width:500px) {
  ...
  <div>
    <div class="panel shadow1">
         <form class="login-form" method="post" action="Cars_delete_Pro.jsp">
             <h1 class="animated fadeInUp animate1" id="title-login">캠핑카 정보 삭제</h1>
             <h5>삭제하려는 캠핑카의 ID를 입력하세요</h5>
             <br>
             <h1 class="animated fadeInUp animate1 hidden" id="title-signup"></h1>
             <fieldset id="login-fieldset">
                 <input class="login animated fadeInUp animate2" name="car_id" type="text"  required   placeholder="캠핑카ID" value="" >        
             </fieldset>
             <input type="submit" class="login_form button animated fadeInUp animate4" action="Cars_delete_Pro.jsp" value="입력완료">
