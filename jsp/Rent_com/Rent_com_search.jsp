...
<div class="animated bounceInDown">
  <div class="container">
	...
	<table>
		<caption><a style="float:left; font-size: 1.5em;" >회사명 검색</a></caption>
		<caption><br></caption>
		<thead>
			<tr>
				<th>회사ID</th>
	...
	<tbody>
		<%
			...
			conn = DriverManager.getConnection(url, user, password);
				...
				if(!"".equals(word)){
					word = "%" + word + "%";
					sql += "where 1 = 1 and com_name like ? order by com_id";				
				}
				...
				while(rs.next()){
							...
							String com_tel =rs.getString("com_tel");
							String com_manager =rs.getString("com_manager");
							String com_manager_email =rs.getString("com_manager_email");
...
<tfoot>
	<td colspan="10" class="tablefoot"></td>
	   ...
	   <br>
	   <br>
      <span><a href="Rent_com_Select.jsp">돌아가기</a></span>
    </div>
</div>
