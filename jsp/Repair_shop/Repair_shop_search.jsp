...
<div class="animated bounceInDown">
  <div class="container">
	...
	<table>
		<caption><a style="float:left; font-size: 1.5em;" >정비소 검색</a></caption>
		<caption><br></caption>
		<thead>
			<tr>
				<th>정비소ID</th>
	...
	<tbody>
		<%
			...
			conn = DriverManager.getConnection(url, user, password);
				...
				String sql= " select * from repair_shop ";
				
				if(!"".equals(word)){
					word = "%" + word + "%";
					sql += "where 1 = 1 and shop_name like ? order by repair_shop_id";					
				}
				...
				while(rs.next()){
							...
							String shop_addr =rs.getString("shop_addr");
							String shop_tel =rs.getString("shop_tel");
							String shop_manager =rs.getString("shop_manager");
							String shop_manager_email =rs.getString("shop_manager_email");
...
<tfoot>
	<td colspan="10" class="tablefoot"></td>
	   ...
	   <br>
	   <br>
      <span><a href="Repair_shop_Select.jsp">돌아가기</a></span>
    </div>
</div>
